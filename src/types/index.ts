...
export const STAFF_MEMBERS = [
  'Budi Santoso', 'Sari Dewi', 'Ahmad Rahman', 'Lina Sari', 'Eko Prasetyo',
  'Nina Rahayu', 'Dedi Kurniawan', 'Maya Sari', 'Joko Widodo', 'Rina Susanti',
  'Agus Setiawan', 'Dewi Lestari', 'Bambang Sutrisno', 'Wati Ningrum', 'Hadi Purnomo',
  'Lia Permata', 'Rudi Hartono', 'Sri Wahyuni', 'Tono Supriyanto', 'Ani Widiastuti',
  'Doni Pratama', 'Sinta Maharani', 'Fajar Nugroho', 'Indah Sari'
];
